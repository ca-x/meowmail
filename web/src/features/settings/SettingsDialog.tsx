...
import { Bot, CalendarDays, Database, MailOpen, Settings2, ShieldCheck, SlidersHorizontal, Sparkles } from "lucide-react"
...
const tabs: Array<{ value: SettingsTab; label: "settingsGeneral" | "settingsMail" | "settingsAi" | "settingsCalendar" | "settingsAutomation" | "settingsSecurity" | "settingsData"; icon: typeof Settings2 }> = [
